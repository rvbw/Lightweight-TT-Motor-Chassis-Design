...
## Design Scope
- Single-part mechanical design (no assembly).
- Designed for 3D printing.
- Weight and size verified using slicing software.

## Validation
- Weight checked using slicer software.
- Dimensions verified to stay within required limits.
- Design optimized for minimal material usage while maintaining structural integrity.
